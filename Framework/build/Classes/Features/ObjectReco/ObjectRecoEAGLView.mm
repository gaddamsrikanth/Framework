...
@interface ObjectRecoEAGLView (PrivateMethods)
...
@implementation ObjectRecoEAGLView
...
- (id)initWithFrame:(CGRect)frame appSession:(SampleApplicationSession *) app
{
    ...
    [[NSNotificationCenter defaultCenter] removeObserver:self name:@"popUpAlert" object:nil];
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(popUpAlert) name:@"popUpAlert" object:nil];
    //Vuforia::deinit();
...
- (void)renderFrameWithState:(const Vuforia::State &)state projectMatrix:(Vuforia::Matrix44F &)projectionMatrix
{
    ...
    for (int i = 0; i < state.getNumTrackableResults(); ++i) {
        ...
        [[NSNotificationCenter defaultCenter] postNotificationName:@"popPresentPage" object:self];


       /* [[NSNotificationCenter defaultCenter] postNotificationName:@"popPresentPage" object:self];
        CVWrapper *cv = [[CVWrapper alloc] init];
        UIViewController *vc = [cv navigateView];
...
-(void)popUpAlert
{
    UIAlertView *anAlertView = [[UIAlertView alloc] initWithTitle:@"Alert"
                                                          message:@"Image already Scanned"
                                                         delegate:self
